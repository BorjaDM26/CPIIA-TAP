	...
	<body>
        ...
        <div class="contenido col-md-9">
            ...
            <table class="table table-sm table-hover col-md-11">
                <thead>
                    <tr>
                        <th class="text-center" scope="col"><a href="AdminComisionConsultar.php?pagina=<?php echo $pagina; ?>&idComision=<?php echo $_REQUEST["idComision"]; ?>&column=NumColegiado&order=<?php echo $asc_or_desc; ?>">Nº de colegiado <i class="fas fa-sort<?php echo $column == 'NumColegiado' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                        <th class="text-center" scope="col"><a href="AdminComisionConsultar.php?pagina=<?php echo $pagina; ?>&idComision=<?php echo $_REQUEST["idComision"]; ?>&column=Nombre&order=<?php echo $asc_or_desc; ?>">Nombre <i class="fas fa-sort<?php echo $column == 'Nombre' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                        <th class="text-center" scope="col"><a href="AdminComisionConsultar.php?pagina=<?php echo $pagina; ?>&idComision=<?php echo $_REQUEST["idComision"]; ?>&column=Apellidos&order=<?php echo $asc_or_desc; ?>">Apellidos <i class="fas fa-sort<?php echo $column == 'Apellidos' ? '-' . $up_or_down : ''; ?>"></i></a></th>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    <?php
                        ...
                        if($pagina<=1){
                            echo '<li class="page-item disabled"><a class="page-link" href="AdminComisionConsultar.php?pagina='.$prevPage.'&idComision='.$_REQUEST['idComision'].$clausulaORD.'">Anterior</a></li>';
                        } else {
                            echo '<li class="page-item"><a class="page-link" href="AdminComisionConsultar.php?pagina='.$prevPage.'&idComision='.$_REQUEST['idComision'].$clausulaORD.'">Anterior</a></li>';
                        }
                        while ($paginacionBotones['Inicio'] <= $paginacionBotones['Fin']){
                            if($paginacionBotones['Inicio']==$pagina){
                                echo '<li class="page-item active"><a class="page-link" href="AdminComisionConsultar.php?pagina='.$paginacionBotones['Inicio'].'&idComision='.$_REQUEST['idComision'].$clausulaORD.'">'.$paginacionBotones['Inicio'].'</a></li>';
                            } else {
                                echo '<li class="page-item"><a class="page-link" href="AdminComisionConsultar.php?pagina='.$paginacionBotones['Inicio'].'&idComision='.$_REQUEST['idComision'].$clausulaORD.'">'.$paginacionBotones['Inicio'].'</a></li>';
                            }
                            $paginacionBotones['Inicio']++;
                        }
                        if($pagina>=$maxPaginas){
                            echo '<li class="page-item disabled"><a class="page-link" href="AdminComisionConsultar.php?pagina='.$nextPage.'&idComision='.$_REQUEST['idComision'].$clausulaORD.'">Siguiente</a></li>';
                        } else {
                            echo '<li class="page-item"><a class="page-link" href="AdminComisionConsultar.php?pagina='.$nextPage.'&idComision='.$_REQUEST['idComision'].$clausulaORD.'">Siguiente</a></li>';
                        }
                    ?>
                </ul>
            </nav>
