	...
	<body>
        ...
        <div class="contenido col-md-9">
            ...
            <table class="table table-sm table-hover col-md-11">
                <thead>
                    <tr>
                        <th class="text-center" scope="col"><a href="AdminEspecializacionConsultar.php?idEspecializacion=<?php echo $_REQUEST["idEspecializacion"]; ?>&column=NumColegiado&order=<?php echo $asc_or_desc; ?>">Nº de colegiado <i class="fas fa-sort<?php echo $column == 'NumColegiado' ? '-' . $up_or_down : ''; ?>"></i></a></th>
