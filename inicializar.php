<?php
	...
	$stmt = $conn->prepare("INSERT INTO `".$database."`.`colegiado` (`NumColegiado`, `Pass`, `Rol`, `Nombre`, `Apellidos`, `DomicilioProfesional`,`Localidad`, `CodigoPostal`, `Provincia`, `TelefonoProfesional`, `CorreoElectronico`, `URL`) VALUES (1, ?, 'Responsable', 'Administrador', 'PHP', 'Calle del Olmo, N01, 1ºA', 'Málaga', '11111', 'Málaga', '650000001','RamonG@mail.com', 'www.ramonggg.com')");
